<?php
function PricerrTheme_dwolla_main_payment_response_payment()
{
	
	if(isset($_POST['OrderId'])):
		
		$cust 					= $_POST['OrderId'];
		$cust 					= get_option('extras_dw_'.$cust);
		$cust 					= explode("|",$cust);
		...
		$payment_status = $_POST['Status']; // Completed
		...
		$mc_gross 				= $_POST['Amount']; // - $_POST['mc_fee'];
