	...
	class UltimateBrandingAdmin {
		...
		function network_admin_page( ) {
			...
			foreach($modules as $key => $title) {
				switch( $key ) {
					case 'favicons.php':
					case 'login-image.php':						if(!ub_has_menu('branding&amp;tab=images')) add_submenu_page('branding', __('Images','ub'), __('Images','ub'), $capability, "branding&amp;tab=images", array(&$this,'handle_images_panel'));
																break;

					case 'custom-admin-bar.php':				if(!ub_has_menu('branding&amp;tab=adminbar')) add_submenu_page('branding', __('Admin Bar','ub'), __('Admin Bar','ub'), $capability, "branding&amp;tab=adminbar", array(&$this,'handle_adminbar_panel'));
																break;

					case 'admin-help-content.php':				if(!ub_has_menu('branding&amp;tab=help')) add_submenu_page('branding', __('Help Content','ub'), __('Help Content','ub'), $capability, "branding&amp;tab=help", array(&$this,'handle_help_panel'));
																break;

					case 'global-footer-content.php':
					case 'admin-footer-text.php':				if(!ub_has_menu('branding&amp;tab=footer')) add_submenu_page('branding', __('Footer Content','ub'), __('Footer Content','ub'), $capability, "branding&amp;tab=footer", array(&$this,'handle_footer_panel'));
																break;
					...
					case 'remove-permalinks-menu-item.php':		if(!ub_has_menu('branding&amp;tab=permalinks')) add_submenu_page('branding', __('Permalinks Menu','ub'), __('Permalinks Menu','ub'), $capability, "branding&amp;tab=permalinks", array(&$this,'handle_permalinks_panel'));
																break;

					case 'site-generator-replacement.php':		if(!ub_has_menu('branding&amp;tab=sitegenerator')) add_submenu_page('branding', __('Site Generator','ub'), __('Site Generator','ub'), $capability, "branding&amp;tab=sitegenerator", array(&$this,'handle_sitegenerator_panel'));
																break;

					case 'site-wide-text-change.php':			if(!ub_has_menu('branding&amp;tab=textchange')) add_submenu_page('branding', __('Text Change','ub'), __('Text Change','ub'), $capability, "branding&amp;tab=textchange", array(&$this,'handle_textchange_panel'));
																break;

					case 'custom-login-css.php':
					case 'custom-admin-css.php':				if(!ub_has_menu('branding&amp;tab=css')) add_submenu_page('branding', __('CSS','ub'), __('CSS','ub'), $capability, "branding&amp;tab=css", array(&$this,'handle_css_panel'));
																break;
