...
<div class="request_div_widget">
        ...
        <div class="request_span"><?php _e("Request Wall:<br><br>Get help from our carefully vetted freelance scientists and R&D labs.","PricerrTheme"); ?></div>
         ...
         <input type="submit" value="<?php _e("Submit Request","PricerrTheme"); ?>" name="submit_prepare_request" id="suggest_job_btn" class="i_will_continue" />
        </form>
        </div>
...
<?php 
	...
	$post = get_post(get_the_ID());
			...
			echo '<li>';
			echo '<span>'.sprintf(__('<a href="%s">%s</a>',"PricerrTheme"),$lnk,$author).':</span><br/>';
