...
<div class="my_new_box_title"><?php
						if(empty($term_title)) echo __("All Listings",'PricerrTheme');
						else echo sprintf( __("Latest Available Listings in %s",'PricerrTheme'), $term_title);
					?> </div>


<div class="filter_jobs"><div class="padd5">
<!--        <div class="filter_div">
       <//?php _e("Filter equipment by:",'PricerrTheme'); ?></div> <ul id="filter_jobs_list">
...
<li><a href="</?php echo pricerrtheme_filter_switch_link_from_home_page('express'); ?>"</?php echo ($my_order == "express" ? 'class="active_link"' : ""); ?>></?php _e("Express Equipments","PricerrTheme"); ?></a></li>
...
<?php  
		...
		echo __('No equipment posted.',"PricerrTheme");
