...
?>
 ...
 <div id="content">
            ...
            <div class="padd10">
                ...
                <br/><br/>
                <?php echo '<a href="'.get_bloginfo('siteurl').'/?pay_for_item=credits&jobid='.$pid.'&confirm=1&from='.$time_from.'
					&to='.$time_to.'&price_option='.$price_option.'">'.__('Confirm Purchase','PricerrTheme').'</a>'; ?>
