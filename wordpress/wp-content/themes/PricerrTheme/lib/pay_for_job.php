...
function PricerrTheme_pay_for_job_area_function()
{
    ...
    <?php
		...
		echo '<a class="payment_feat" href="'.get_bloginfo('siteurl').'/?jb_action=pay_featured&method=paypal&jobid='.$pid.'">'. __('Pay with Credit Card or PayPal','PricerrTheme').'</a> ';
