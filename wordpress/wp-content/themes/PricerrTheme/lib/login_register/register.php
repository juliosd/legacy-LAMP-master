		  ...
		  switch( $_REQUEST["action"] ) 
		  {
			...
			case 'register':
			  require_once( ABSPATH . WPINC . '/registration-functions.php');
				...
				$errors = PricerrTheme_register_new_user_sitemile($user_login, $user_email);
...
function PricerrTheme_register_new_user_sitemile( $user_login, $user_email ) {
	$errors = new WP_Error();
	global $current_theme_locale_name;
	...
	PricerrTheme_new_user_notification($user_id, $user_pass );
