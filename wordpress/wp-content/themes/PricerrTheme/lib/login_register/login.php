...
function PricerrTheme_sitemile_filter_ttl($title){ global $real_ttl; return $real_ttl." - ".get_bloginfo('sitename');}
		...
		?>
            ...
            <div class="padd10">
                ...
                <ul id="logins">
                            ...
                            title="<?php _e('Are you lost?',$current_theme_locale_name) ?>"><?php _e('Home',$current_theme_locale_name) ?></a></li>
						  <?php if (get_settings('users_can_register')) : ?>
							<li><a href="<?php bloginfo('wpurl'); ?>/wp-register.php"><?php _e('Register',$current_theme_locale_name) ?></a></li>
						  <?php endif; ?>
