...
function PricerrTheme_my_account_reviews_area_function()
{
	...
	//-------------------------------------	
		...
		<div class="box_title3"><?php _e("My Ratings",'PricerrTheme'); ?></div>
			...
			?>
            <div id="padd10">
            <a class="green_btn"<?php  echo ($third_page == "home" ? 'class="actiove"' : ""); ?> href="<?php echo $rev_pg_lnk; ?>"><?php _e("Ratings to Award","PricerrTheme"); ?></a>
            <a class="green_btn"<?php  echo ($third_page == "waiting" ? 'class="actiove"' : ""); ?> href="<?php echo $rev_pg_lnk; ?>pg=waiting"><?php _e("Pending Ratings","PricerrTheme"); ?></a>
            <a class="green_btn"<?php  echo ($third_page == "my_rev" ? 'class="actiove"' : ""); ?> href="<?php echo $rev_pg_lnk; ?>pg=my_rev"><?php _e("My Ratings","PricerrTheme"); ?></a>
