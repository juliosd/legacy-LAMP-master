...
function PricerrTheme_my_account_shopping_area_function()
{
	...
	//-------------------------------------	
		...
		<div class="my_box3">
            ...
            <div class="padd10">
         <a class="green_btn"<?php  echo ($pg == "home" ? 'class="actiove"' : ""); ?> href="<?php echo $shp_pg_lnk; ?>"><?php echo sprintf(__("Active Jobs (%s)","PricerrTheme"),$act_nr ); ?></a>
         <a class="green_btn"<?php  echo ($pg == "pending" ? 'class="actiove"' : ""); ?> href="<?php echo $shp_pg_lnk; ?>pg=pending"><?php echo sprintf(__("Pending my Review (%s)","PricerrTheme"),$rev_nr); ?></a>
         <a class="green_btn"<?php  echo ($pg == "cancelled" ? 'class="actiove"' : ""); ?> href="<?php echo $shp_pg_lnk; ?>pg=cancelled"><?php echo sprintf(__("Cancelled (%s)","PricerrTheme"),$can_nr ); ?></a>
         <a class="green_btn"<?php  echo ($pg == "completed" ? 'class="actiove"' : ""); ?> href="<?php echo $shp_pg_lnk; ?>pg=completed"><?php echo sprintf(__("Completed (%s)","PricerrTheme"),$com_nr ); ?></a>
