...
function PricerrTheme_my_account_sales_area_function()
{
	...
	if(!isset($pg)) $pg = 'home';	
        ...
        <a class="green_btn"<?php  echo ($pg == "home" ? 'class="green_btn"' : ""); ?> href="<?php echo $sal_pg_lnk; ?>"><?php echo sprintf(__("Active Jobs (%s)","PricerrTheme"), $act_jb); ?></a>
        <a class="green_btn"<?php  echo ($pg == "delivered" ? 'class="green_btn"' : ""); ?> href="<?php echo $sal_pg_lnk; ?>pg=delivered"><?php echo sprintf(__("Delivered (%s)","PricerrTheme"),$del_jb); ?></a>
        <a class="green_btn"<?php  echo ($pg == "completed" ? 'class="green_btn"' : ""); ?> href="<?php echo $sal_pg_lnk; ?>pg=completed"><?php echo sprintf(__("Completed (%s)","PricerrTheme"),$com_jb); ?></a>
        <a class="green_btn"<?php  echo ($pg == "cancelled" ? 'class="green_btn"' : ""); ?> href="<?php echo $sal_pg_lnk; ?>pg=cancelled"><?php echo sprintf(__("Cancelled (%s)","PricerrTheme"),$can_jb); ?></a>
