	...
	$the_query = new WP_Query( $args );
		...
		?>
        		...
        		<?php
					...
					if($pricerrtheme_show_pagination_homepage != "no"):
				
				?>
<!--
        	<div class="show_all_jobs">
             <a href="<?php echo get_post_type_archive_link('job') ?>"><?php _e('Show All Jobs','PricerrTheme'); ?></a>            
            </div>
Julio: changed pricertheme_show_pagination_hompage equal to 'Yes' to 'No' then commented out this "show_all_jobs block -->     
